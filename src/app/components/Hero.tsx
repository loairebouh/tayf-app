  ...
  return (
    <section className="relative w-full h-[75vh] md:h-[85vh]">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white px-4 z-20">
        <h1 className={`text-6xl font-bold leading-tight font-serif ${qatarBold.className}`}>
        ...
        <button className={`mt-6 border border-white text-white py-2 px-6 rounded-full hover:bg-primary transition duration-300 flex flex-row items-center gap-2 font-light text-2xl ${qatarMeduim.className} `}> 
          Shop Now
