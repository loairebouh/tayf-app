    ...
    <nav className="border-gray-600 text-white">
      <div className="flex items-center justify-between border-b border-gray-600 bg-primary px-6 py-3"> 
        <div className="hidden space-x-6 lg:block">
          <Link
            href={"/allProducts"}
            className="text-md font-semibold text-white hover:text-gray-600" 
          >
            Shop
          </Link>
          <Link
      ...
      <div
        className={`border-b border-gray-600 bg-primary py-2 transition-opacity duration-300 ease-in-out lg:hidden ${isMenuOpen ? "opacity-100" : "pointer-events-none opacity-0"}`}
      >
        <a
          href="#"
